...
public class MySettingRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private GoPageSlideCallBack pageSlideCallBack;
    private GoNoimgCallBack noimgCallBack;
    private GoNoCacheCallBack noCacheCallBack;
    ...
    public interface GoPageSlideCallBack{
        void onPageSlide();
    }
    public interface GoNoimgCallBack{
        void onNoImg();
    }
    public interface GoNoCacheCallBack{
        void onNoCache();
    }

    public void setPageSlideCallBack(GoPageSlideCallBack pageSlideCallBack) {
        this.pageSlideCallBack = pageSlideCallBack;
    }

    public void setNoimgCallBack(GoNoimgCallBack noimgCallBack) {
        this.noimgCallBack = noimgCallBack;
    }

    public void setNoCacheCallBack(GoNoCacheCallBack noCacheCallBack) {
        this.noCacheCallBack = noCacheCallBack;
    }
}
